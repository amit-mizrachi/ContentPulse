...
class TestMongoDBClient:
    ...
    def repository(self, mock_mongo):
        ...
        with patch("src.utils.services.clients.mongodb_client.get_config_service") as mock_config, \
             patch("src.utils.services.clients.mongodb_client.MongoClient", return_value=mock_client):
            ...
            from src.utils.services.clients.mongodb_client import MongoDBClient
            repo = MongoDBClient()
